...
namespace Inspinia_MVC5
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // dataTablesResponsive css styles
            bundles.Add(new StyleBundle("~/Content/dataTablesResponsive/dataTablesResponsiveStyles").Include(
                      "~/Content/plugins/dataTablesResponsive/jquery.dataTables.min.css",
                      "~/Content/plugins/dataTablesResponsive/responsive.dataTables.min.css"));


            //dataTablesResponsive
            bundles.Add(new ScriptBundle("~/Content/dataTablesResponsive").Include(
                      "~/Scripts/plugins/dataTablesResponsive/dataTables.responsive.min.js",
                      "~/Scripts/plugins/dataTablesResponsive/jquery.dataTables.min.js",
                      "~/Scripts/plugins/dataTablesResponsive/jquery-3.3.1.js"));
            ...
            bundles.Add(new StyleBundle("~/plugins/select2Styles").Include(
                      "~/Content/plugins/Select2new/select2.min.css"));

            // select Jquerydd Styless
            bundles.Add(new StyleBundle("~/plugins/Jquerydd").Include(
                "~/Content/plugins/Jquerydd/jquery.dropdown.css"));

            // select Jquerydd 
            bundles.Add(new ScriptBundle("~/plugins/Jquerydd").Include(
                "~/Content/plugins/Jquerydd/jquery.dropdown.js"));


            // Select2
            bundles.Add(new ScriptBundle("~/plugins/select2").Include(
                      "~/Scripts/plugins/Select2new/select2.min.js"));
            ...
            // Bootstrap Select
            bundles.Add(new StyleBundle("~/styles/bootstrap-select").Include("~/Content/bootstrap-select.min.css"));
            bundles.Add(new ScriptBundle("~/plugins/bootstrap-select").Include("~/Scripts/bootstrap-select.min.js"));
